...
function eeBuildAll() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeBuildAll()" );
		Logger();
	}
	$arg = func_get_arg( 0 );
	if( $arg == "New" ) {
...
function eeBuildMain() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeBuildMain()" );
		Logger();
	}
...
function eeDirectorBuild() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDirectorBuild()" );
		Logger();
	}
   
   $func = $_POST['func'];
	if( $func == "main" ) eeBuildMain();
   if( $func == "buildNew" ) eeBuildAll("New");
   if( $func == "buildUpdate" ) eeBuildAll("Update");;
...
function eeDisplayAddress() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayAddress()" );
		Logger();
	}
...
function eeDisplayAdmin() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayAdmin()" );
		Logger();
	}
...
function eeDisplayEmail1() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayEmail1()" );
		Logger();
	}
...
function eeDisplayEmail2() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayEmail2()" );
		Logger();
	}
...
function eeDisplayGrades() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayGrades()" );
		Logger();
	}
...
function eeDisplayMain() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayMain()" );
		Logger();
	}
...
function eeDisplayParents() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayParents()" );
		Logger();
	}
...
function eeDisplayPhone() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayPhone()" );
		Logger();
	}
...
function eeDisplayStudents() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplayStudents()" );
		Logger();
	}
...
function eeDisplaySwaps() {
	include( "globals.php" );
	if( $gTrace ) {
		array_push( $gFunction, "eeDisplaySwaps()" );
		Logger();
	}
